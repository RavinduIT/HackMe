            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: 6, alignItems: 'center' }}>
                <button onClick={async () => {
                  const r = await window.hackme.scanFromHistory(selected.id);
                  if (r?.scanId) navigate(`/scanner/active/${r.scanId}`);
                }} className="hm-btn hm-btn-accent-ghost" style={{ fontSize: 9, padding: '3px 8px' }}>Scan</button>
