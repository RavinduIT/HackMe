      ...
      <Section title="Data Management">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 14px', background: 'var(--bg-0)', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}>
            ...
            <button onClick={async () => { try { await window.hackme.clearProxyHistory(); flash('Proxy history cleared'); } catch (e: any) { flash('Error: ' + e.message); } }} className="hm-btn hm-btn-ghost" style={{ fontSize: 11, padding: '5px 14px' }}>Clear</button>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 14px', background: 'var(--bg-0)', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}>
            <div>
            ...
            <button onClick={async () => { try { await window.hackme.clearFindings(); flash('Findings cleared'); } catch (e: any) { flash('Error: ' + e.message); } }} className="hm-btn hm-btn-ghost" style={{ fontSize: 11, padding: '5px 14px' }}>Clear</button>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 14px', background: 'var(--bg-0)', borderRadius: 'var(--radius)', border: '1px solid var(--border)' }}>
            <div>
            ...
            <button onClick={async () => { try { await window.hackme.clearScans(); flash('All scans cleared'); } catch (e: any) { flash('Error: ' + e.message); } }} className="hm-btn hm-btn-ghost" style={{ fontSize: 11, padding: '5px 14px' }}>Clear</button>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 14px', background: 'rgba(255,92,92,0.03)', borderRadius: 'var(--radius)', border: '1px solid rgba(255,92,92,0.12)' }}>
            ...
            <button onClick={async () => { if (confirm('This will delete ALL data. Are you sure?')) { try { await window.hackme.clearAllData(); flash('All data cleared'); } catch (e: any) { flash('Error: ' + e.message); } } }} className="hm-btn hm-btn-danger" style={{ fontSize: 11, padding: '5px 14px' }}>Reset All</button>
          </div>
        </div>
      </Section>
