interface Window {
  hackme: {
    ...
    oobStart: () => Promise<any>;
    oobStop: () => Promise<boolean>;
    oobStatus: () => Promise<any>;
    oobGenerateId: () => Promise<string>;
    onOobCallback: (callback: (data: any) => void) => () => void;
    intruderStart: (config: any) => Promise<boolean>;
    intruderStop: () => Promise<boolean>;
    intruderGetPayloads: () => Promise<Record<string, string[]>>;
    onIntruderResult: (callback: (data: any) => void) => () => void;
